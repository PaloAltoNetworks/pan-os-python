...
class CloudServicesPlugin(VersionedPanObject):
    ...
    def _setup(self):
        ...
        params.append(
            VersionedParamPath("all_traffic_to_dc", vartype="yesno", path="traffic-steering/All-Traffic-To-DC", version="9.1.0")
        )
...
class AggBandwidth(VersionedPanObject):
    ...
    def _setup(self):
        ...
        params.append(
            VersionedParamPath("enabled", vartype="yesno", path="enabled", version="9.1.0")
        )
...
class Region(VersionedPanObject):
    ...
    def _setup(self):
        ...
        params = []     
        params.append(
            VersionedParamPath("allocated_bw", path="allocated-bw", version="9.1.0")
        )  
        params.append(
            VersionedParamPath("spn_name_list", path="spn-name-list", vartype="member", version="9.1.0")
        )  
        self._params = tuple(params)
...
class RemoteNetworks(VersionedPanObject):
    ...
    def _setup(self):
        ...
        params.append(
            VersionedParamPath("overlapped_subnets", vartype="yesno", path="overlapped-subnets", version="9.1.0")
        )
        params.append(
        ...
        params.append(
            VersionedParamPath("trusted_zones", vartype="member", path="trusted-zones", version="9.1.0")
        )
...
class InternalDnsMatch(VersionedPanObject):
    ...
    def _setup(self):
        ...
        params.append(
            VersionedParamPath("domain_list", vartype="member", path="domain-list", version="9.1.0")
        )
        params.append(
            VersionedParamPath("peer_as", vartype="int", path="peer-as", version="9.1.0")
        )
...
class DNSServerBase(VersionedPanObject):
    """Top DNS Class, will be inherited for correct XPATH
    ...
    def add_dns_params(self, same_as_internal):
        ...
        params.append(
            VersionedParamPath("use-cloud-default", vartype="exist", path="use_cloud_default", version="9.1.0")
        )
        if same_as_internal:
            params.append(
                VersionedParamPath("same_as_internal", vartype="exist", path="same-as-internal", version="9.1.0")
            )   
        self._params = tuple(params)       
...
class UdpQueries(VersionedPanObject): 
    ...
    def _setup(self):
        ...
        params = []
        params.append(
            VersionedParamPath("interval", vartype="int", path="retries/interval", default=2, version="9.1.0")
        )
        params.append(
            VersionedParamPath("attempts", vartype="int", path="retries/attempts", default=5, version="9.1.0")
        )
        self._params = tuple(params)
...
class Bgp(VersionedPanObject): #TODO : shoud it be protcol-bgp ?
    ...
    def _setup(self):
        ...
        params.append(
            VersionedParamPath("enable", vartype="yesno", path="enable", version="9.1.0")
        )

        params.append(
            VersionedParamPath("originate_default_route", vartype="yesno", path="originate-default-route", version="9.1.0")
        )
        params.append(
            VersionedParamPath("summarize_mobile_user_routes", vartype="yesno", path="summarize-mobile-user-routes", version="9.1.0")
        )
        params.append(
            VersionedParamPath("do_not_export_routes", vartype="yesno", path="do-not-export-routes", version="9.1.0")
        )
        ...
        params.append(
            VersionedParamPath("peer_ip_address", path="peer-ip-address", version="9.1.0")
        )
        params.append(
            VersionedParamPath("local_ip_address", path="local-ip-address", version="9.1.0")
        )
        params.append(
            VersionedParamPath("secret",vartype="encrypted", path="secret", version="9.1.0")
        )
...
class BgpPeer(VersionedPanObject):
    ...
    def _setup(self):
        ...
        params.append(
            VersionedParamPath("same_as_primary", vartype="yesno", path="same-as-primary", version="9.1.0")
        )
        params.append(
            VersionedParamPath("peer_ip_address", path="peer-ip-address", version="9.1.0")
        )
...
class RoutingPreference(VersionedPanObject):
    ...
    def _setup(self):
        ...
        params.append(
            VersionedParamPath("default", vartype="exist", path="default", version="9.1.0")
        )
...
class RemoteNetwork(VersionedPanObject):
    ...
    def _setup(self):
        ...
        params.append(
            VersionedParamPath("subnets", vartype="member", path="subnets", version="9.1.0")
        )
        params.append(
        ...
        params.append(
            VersionedParamPath("secondary_wan_enabled", vartype="yesno", path="secondary-wan-enabled", version="9.1.0")
        )
        params.append(
            VersionedParamPath("ecmp_load_balancing", path="ecmp-load-balancing", version="9.1.0",  values=("enabled-with-symmetric-return", "disabled")) 
        ) 
        params.append(
            VersionedParamPath("secondary_ipsec_tunnel", path="secondary-ipsec-tunnel", version="9.1.0")
        )         
        params.append(
            VersionedParamPath("spn_name", path="spn-name", version="9.1.0")
        )  
        params.append(
            VersionedParamPath("inbound_flow_over_pa_backbone", vartype="yesno", path="inbound-flow-over-pa-backbone", version="9.1.0")
        )
